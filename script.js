        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (nameInput) {
                ...
                if (!nameValue) {
                    ...
                    showError(nameInput, 'الاسم يجب أن يكون حرفين على الأقل');
                    isValid = false;
                } else {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ced2d932-87b1-4d12-8e38-d5af7f042a33',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ced2d932-87b1-4d12-8e38-d5af7f042a33';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ced2d932-87b1-4d12-8e38-d5af7f042a33';
